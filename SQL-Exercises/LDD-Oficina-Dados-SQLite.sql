...
-- Insero de registos na tabela codPostal
...
-- Insero de registos na tabela Cliente
...
INSERT INTO Cliente (nome, morada, codPostal1, codPostal2, telefone)
	VALUES ('Ado Lopes S','Rua Domingos de Matos, 200 3� Esq','4400','120','963670913');

-- Insero de registos na tabela Marca
INSERT INTO Marca (nome) VALUES ('Renault');
INSERT INTO Marca (nome) VALUES ('Volvo');

-- Insero de registos na tabela Modelo
...
-- Insero de registos na tabela Carro
...
-- Insero de registos na tabela Reparacao
...
-- Insero de registos na tabela Especialidade
...
-- Insero de registos na tabela Funcionario
...
INSERT INTO Funcionario(nome, morada, codPostal1, codpostal2, telefone, idEspecialidade)
	VALUES ('Mrio Teixeira', 'Rua Seca, 17', 4400, 210, '227519090', 2);
INSERT INTO Funcionario(nome, morada, codPostal1, codpostal2, telefone, idEspecialidade)
	VALUES ('Rogrio Silva', 'Rua dos Caldeireiros, 312, 3F', 4400, 112, '227403728', 2);
INSERT INTO Funcionario(nome, morada, codPostal1, codpostal2, telefone, idEspecialidade)
	VALUES ('Lus Pereira', 'Rua Teixeira de Pascoaes, 117, 2 D', 4450, 117, '225901707', 3);

-- Insero de registos na tabela FuncionarioReparacao
