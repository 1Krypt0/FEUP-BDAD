...
VALUES 
	(233143335, "Afonso Carvalho", "Rua Vasco de Lobeira, 255", 936653870),
...
VALUES
	(1, 150000, 2021-11-01),
	(2, 870000, 2022-04-29),
	(3, 1450000, 2022-01-15),
	(4, 730000, 2021-12-10);


INSERT INTO obra(nr_obra, data_inicio, custo, area_terreno, area_interior, estado, rua, nr_porta, cod_postal)
VALUES
	(1, 2020-03-01, 110000, 230, 190, "Por Aprovar", "Avenida da Boavista", 925, 4050112),
	(2, 2020-11-01, 60000, 110, 70, "Em Andamento", "Rua das Flores", 21, 4050262),
	(3, 2021-11-01, 430000, 315.5, 195.5, "Aprovada", "Rua das Flores", 195, 4050262),
	(4, 2022-04-29, 570000, 520, 420, "Em Andamento", "Praça da República", 23, 4050495);
...
VALUES
	("Avenida Dr. António Machado", 130, 4100068, "Leça"),
	("Rua Luís de Camões", 44, 4785331, "Trofa"),
	("Avenida da Boavista", 925, 4050112, "Porto"),
	("Rua das Flores", 195, 4050262, "Porto"),
	("Praça da República", 23, 4050495, "Porto");


INSERT INTO estaleiro(nr_estaleiro, capacidade, rua, nr_porta, cod_postal)
VALUES
	(1, 900, "Avenida Dr. António Machado", 130, 4100068),
	(2, 1700, "Rua Luís de Camões", 44, 4785331);
...
VALUES
	...
	("11-ZX-50", 34.1, 160000, "Retroescavadora", 3);
...
VALUES
	...
	(290345724, "Mauro Carvalhal",  917723422, 600,  "Ensino Secundário", 30, "M"),
...
INSERT INTO empregado_de_escritório(nif, estacao_trabalho, especialidade)
VALUES
	(287879833, "Desenho", "Arquiteto"),
	(220209493, "Finanças", "Gestor"),
	(285852988, "Desenho", "Engenheiro Civil"),
	(210103903, "Finanças", "Contabilista");


INSERT INTO empregado_de_obra(nif, anos_experiencia, cargo, especialidade)
VALUES
	(211000091, 7,  "Chefe de Obra", "Eletricista"),
...
INSERT INTO cliente_obra_projeto(cliente, obra, projeto)
VALUES
	(239143555, 1, 1)
	(223459225, 2, 2)
	(133657483, 3, 3)
